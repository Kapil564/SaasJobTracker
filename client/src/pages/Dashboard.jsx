...
export default function Dashboard() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'Dashboard':
        return <DashboardView jobs={jobs} updateJobStatus={updateJobStatus} toggleStar={toggleStar} onAddJob={handleOpenAddJob} addToast={addToast} />;
      case 'Applications':
        return <ApplicationsView jobs={jobs} toggleStar={toggleStar} />;
      case 'Resumes':
        return <ResumeView />;
      default:
